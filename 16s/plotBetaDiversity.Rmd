...
betweenSites<-apply(allCombo,1,function(xx,distMat)pullDists(list(samples[isEnough[samples$Code]&samples$area==xx[1],'name'],samples[isEnough[samples$Code]&samples$area==xx[2],'name']),distMat),as.matrix(uniDist))
withinSites<-lapply(nonTL,function(xx,distMat)pullDists(list(samples[isEnough[samples$Code]&samples$area==xx,'name'],samples[isEnough[samples$Code]&samples$area==xx,'name']),distMat),as.matrix(uniDist))
