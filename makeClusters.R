...
file.copy('out/pcoa_matK.pdf','out/Fig.5A.pdf')
file.copy('out/pcoa_rbcL.pdf','out/Fig.5B.pdf')
file.copy('out/tsne_matK.pdf','out/Fig.S6A.pdf')
file.copy('out/tsne_rbcL.pdf','out/Fig.S6B.pdf')
